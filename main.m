...
Variable=Compute_tuning(Rates,param,p_tuning,0);  %To not generate the plots, set the last argument to 0

%Compute the order parameters r0,r0A,r0B,rA,rB
[OrdParam,Err_OrdParam]=Compute_order_param(Rates,param,Variable,color_map,0);
